...
* @param {*} properties
*/
export default function SideHexagon({ w, d, h = d * ratio, x, y, z, rx, ry, rz, className }) {
...
SideHexagon.prototype = Object.create(Shape.prototype);
SideHexagon.prototype.constructor = SideHexagon;
